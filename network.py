...
ip = ipaddress.IPv4Address("10.112.160.96")
...
network = ipaddress.IPv4Network("10.112.160.96/27")
...
print("Overlaps 10.112.160.96/27:", network.overlaps(ipaddress.IPv4Network("10.112.160.96/27")))